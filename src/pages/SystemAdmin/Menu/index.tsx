...
import { createFromIconfontCN, ExclamationCircleOutlined, QuestionCircleOutlined } from '@ant-design/icons';
...
const IconType = [
  "icon-appstore", "icon-earth", "icon-message", "icon-dashboard", "icon-setting",
  "icon-eye", "icon-location", "icon-edit-square", "icon-save", "icon-piechart",
...
function MenuAdmin(props: MenuAdminProps) {
  ...
  const validateMenuName = () => {
    ...
    if (
      menuName === undefined ||
      Object.values(menuName).filter(v => v === '').length
    ) {
      return Promise.reject('至少填写一种语言的菜单名称');
    }
